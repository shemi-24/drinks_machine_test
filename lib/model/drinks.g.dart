...
Drinks _$DrinksFromJson(Map<String, dynamic> json) => Drinks(
      ...
      strAlcaholic: json['strAlcoholic'] as String?,
...
Map<String, dynamic> _$DrinksToJson(Drinks instance) => <String, dynamic>{
      ...
      'strAlcaholic': instance.strAlcaholic,
      'strGlass': instance.strGlass,
      'strInstruction': instance.strInstructions,
      'strInstructionES': instance.strInstructionsES,
      'strInstructionDE': instance.strInstructionsDE,
      'strInstructionFR': instance.strInstructionsFR,
      'strInstructionIT': instance.strInstructionsIT,
      'strInstructionZHHANS': instance.strInstructionsZHHANS,
      'strInstructionZHHANT': instance.strInstructionsZHHANT,
